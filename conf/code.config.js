...
module.exports = {
  ...
  PRISM_THEME_PREFIX_PATH:
    ...
    'https://cdn.jsdelivr.net/gh/PrismJS/prism-themes@master/themes/prism-duotone-light.css', // 代码块默认主题
  ...
  PRISM_THEME_LIGHT_PATH:
    ...
    'https://cdn.jsdelivr.net/gh/PrismJS/prism-themes@master/themes/prism-duotone-light.css', // 浅色模式主题
  PRISM_THEME_DARK_PATH:
    process.env.NEXT_PUBLIC_PRISM_THEME_DARK_PATH ||
    'https://cdn.jsdelivr.net/gh/PrismJS/prism-themes@master/themes/prism-duotone-light.css', // 深色模式主题
